...
body{margin:0;min-height:100vh;display:grid;place-items:center;background:#0b0c18;color:#eef0ff;font-family:-apple-system,'PingFang SC',sans-serif}.card{position:relative;width:min(86vw,390px);padding:30px 22px;border-radius:22px;background:#17192e;text-align:center}h2{margin:0 0 14px}p{color:#aeb3d1;line-height:1.7}.btn{display:grid;place-items:center;height:50px;border-radius:15px;background:linear-gradient(135deg,#7d8bff,#a06bff);color:#fff;text-decoration:none;font-weight:650}.wechat-guide{display:none;text-align:left}.wechat-guide h2{text-align:center;font-size:23px}.steps{display:grid;gap:10px;margin:22px 0 18px}.step{display:flex;align-items:center;gap:10px;color:#eef0ff;font-size:15px}.number{display:grid;place-items:center;flex:0 0 28px;height:28px;border-radius:50%%;background:rgba(139,127,255,.22);color:#c9c4ff;font-weight:700}.guide-visual{position:relative;height:210px;margin-top:12px;border:1px solid rgba(255,255,255,.10);border-radius:16px;background:#101223;overflow:hidden}.mock-top{height:48px;border-bottom:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.035)}.corner-dots{position:absolute;top:9px;right:12px;display:grid;place-items:center;width:42px;height:30px;border:2px solid #a997ff;border-radius:999px;background:#f2f1ff;color:#27283b;font-size:20px;font-weight:800;box-shadow:0 0 0 5px rgba(151,131,255,.13)}.menu{position:absolute;top:43px;right:12px;width:205px;padding:8px;border-radius:14px;background:#f2f3f8;box-shadow:0 14px 32px rgba(0,0,0,.38)}.menu-row{padding:9px 11px;border-radius:9px;color:#a3a5ad;font-size:13px}.menu-row+.menu-row{margin-top:3px}.menu-row.target{border:2px solid #826fff;background:#e9e5ff;color:#332d5e;font-weight:750;box-shadow:0 0 0 3px rgba(130,111,255,.12)}.is-wechat .wechat-guide{display:block}.is-wechat .normal-copy,.is-wechat .btn{display:none}
</style></head><body><main class=\"card\"><h2 class=\"normal-copy\">继续制作这条开心视频</h2><p class=\"normal-copy\">如果编辑工具已安装，请点击下面的按钮继续。</p><div class=\"wechat-guide\"><h2>打开情绪编辑工具</h2><div class=\"steps\"><div class=\"step\"><span class=\"number\">1</span><span>点右上角“…”</span></div><div class=\"step\"><span class=\"number\">2</span><span>选择“在浏览器中打开”</span></div></div><div class=\"guide-visual\"><div class=\"mock-top\"></div><span class=\"corner-dots\">…</span><div class=\"menu\"><div class=\"menu-row\">转发给朋友</div><div class=\"menu-row target\">在浏览器中打开</div><div class=\"menu-row\">收藏</div><div class=\"menu-row\">其他选项</div></div></div></div><a class=\"btn\" href=\"lugu://remix/%s\">打开情绪编辑工具</a></main><script>if(/MicroMessenger/i.test(navigator.userAgent)&&/Android/i.test(navigator.userAgent))document.body.classList.add('is-wechat');</script></body></html>""" % safe_token
        self._send_html(page)
