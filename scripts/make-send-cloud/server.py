...
body{margin:0;min-height:100vh;display:grid;place-items:center;background:#0b0c18;color:#eef0ff;font-family:-apple-system,'PingFang SC',sans-serif}.card{position:relative;width:min(86vw,390px);padding:30px 22px;border-radius:22px;background:#17192e;text-align:center}h2{margin:0 0 14px}p{color:#aeb3d1;line-height:1.7}.btn{display:grid;place-items:center;height:50px;border-radius:15px;background:linear-gradient(135deg,#7d8bff,#a06bff);color:#fff;text-decoration:none;font-weight:650}.wechat-guide{display:none;margin:22px 0 0;padding:16px;border:1px solid rgba(150,130,255,.28);border-radius:16px;background:rgba(125,139,255,.08);text-align:left}.wechat-guide strong{display:block;margin-bottom:7px;color:#eef0ff;font-size:15px}.wechat-guide p{margin:0;color:#b7bcd7;font-size:14px}.guide-visual{display:flex;align-items:center;justify-content:center;gap:10px;margin-top:13px}.dots{display:grid;place-items:center;width:38px;height:30px;border-radius:999px;background:#eef0ff;color:#202239;font-size:20px;font-weight:700}.arrow{color:#858cac}.menu-item{padding:8px 12px;border-radius:10px;background:rgba(255,255,255,.08);color:#eef0ff;font-size:13px}.is-wechat .wechat-guide{display:block}.is-wechat .normal-copy{display:none}.is-wechat .btn{margin-top:14px;background:transparent;border:1px solid rgba(255,255,255,.16);color:#c5c9dd;font-size:14px}
</style></head><body><main class=\"card\"><h2 class=\"normal-copy\">继续制作这条开心视频</h2><p class=\"normal-copy\">如果编辑工具已安装，请点击下面的按钮继续。</p><div class=\"wechat-guide\"><strong>微信暂时无法直接打开编辑工具</strong><p>请点击右上角“…” ，选择“在浏览器中打开”。</p><div class=\"guide-visual\"><span class=\"dots\">…</span><span class=\"arrow\">→</span><span class=\"menu-item\">在浏览器中打开</span></div></div><a class=\"btn\" href=\"lugu://remix/%s\">打开情绪编辑工具</a></main><script>if(/MicroMessenger/i.test(navigator.userAgent)&&/Android/i.test(navigator.userAgent))document.body.classList.add('is-wechat');</script></body></html>""" % safe_token
        self._send_html(page)
